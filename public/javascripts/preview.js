...
$('#playback').load(function(){
	...
	function playbackCursor( locationId ) {
		...
		this.cursorCodeCode = '<div id="we3ctracker_cursor" '+ 
		 '    style="display: block; position: absolute; z-index: 9999; width: 32px; height: 32px; top: 0; left: 0; '+
		...
		'    style="display: block; position: absolute; z-index: 9999; width: 32px; height: 32px; top: {top}px; left: {left}px; '+
