...
1].e==a.e&&1E3>a.ts-_we3ctr.eventsRepo[_we3ctr.eventsRepo.length-1].ts)return;a.x=b.clientX+_we3ctr.getScrollLeft();a.y=b.clientY+_we3ctr.getScrollTop();b=_we3ctr.getWindowsSize();a.w=b.w;a.h=b.h;console.log(a.x,a.y);_we3ctr.eventsRepo.push(a);break;case "mousemove":a.e=_we3ctr.eventTypesList[b.type];a.x=b.clientX+_we3ctr.getScrollLeft();a.y=b.clientY+_we3ctr.getScrollTop();b=_we3ctr.getWindowsSize();a.w=b.w;a.h=b.h;if(1<=_we3ctr.eventsRepo.length&&_we3ctr.eventsRepo[_we3ctr.eventsRepo.length-1].e==
a.e){var c=_we3ctr.eventsRepo[_we3ctr.eventsRepo.length-1].x-a.x,b=_we3ctr.eventsRepo[_we3ctr.eventsRepo.length-1].y-a.y;if(8>=Math.abs(c)&&8>=Math.abs(b))return;var d=0;0<=c?d=1:0>c&&(d=-1);c=0;0<=b?c=1:0>b&&(c=-1);b=[d,c];if(0==b[0]&&0==b[1])return;b[0]!=_we3ctr.lastMouseMoveState[0]||b[1]!=_we3ctr.lastMouseMoveState[1]?(_we3ctr.eventsRepo.push(a),_we3ctr.lastMouseMoveState=b):_we3ctr.eventsRepo[_we3ctr.eventsRepo.length-1]=a}else _we3ctr.eventsRepo.push(a);break;case "resize":a.e=_we3ctr.eventTypesList[b.type];
b=_we3ctr.getWindowsSize();a.w=b.w;a.h=b.h;1<=_we3ctr.eventsRepo.length&&_we3ctr.eventsRepo[_we3ctr.eventsRepo.length-1].e==a.e?_we3ctr.eventsRepo[_we3ctr.eventsRepo.length-1]=a:_we3ctr.eventsRepo.push(a);break;case "scroll":a.e=_we3ctr.eventTypesList[b.type],a.t=_we3ctr.getScrollTop(),a.l=_we3ctr.getScrollLeft(),1<=_we3ctr.eventsRepo.length&&_we3ctr.eventsRepo[_we3ctr.eventsRepo.length-1].e==a.e?(_we3ctr.eventsRepo[_we3ctr.eventsRepo.length-1].t>a.t?a.d="t":_we3ctr.eventsRepo[_we3ctr.eventsRepo.length-
1].t<a.t?a.d="d":_we3ctr.eventsRepo[_we3ctr.eventsRepo.length-1].l>a.l?a.d="l":_we3ctr.eventsRepo[_we3ctr.eventsRepo.length-1].l<a.l&&(a.d="r"),_we3ctr.eventsRepo[_we3ctr.eventsRepo.length-1].d==a.d?_we3ctr.eventsRepo[_we3ctr.eventsRepo.length-1]=a:_we3ctr.eventsRepo.push(a)):(a.d="",_we3ctr.eventsRepo.push(a))}_we3ctr.eventsRepo.length>=_we3ctr.offloadThreshold&&(_we3ctr.offloadData(),_we3ctr.lastMouseMoveState=[0,0])};
